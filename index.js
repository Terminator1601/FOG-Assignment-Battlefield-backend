...
// Routes
app.get("/api/settings/basic", async (req, res) => {
  const data = await fetchData("/api/settings/basic", "basicSettings");
  res.json(data);
});

app.get("/api/settings/advanced", async (req, res) => {
  const data = await fetchData("/api/settings/advanced", "advancedSettings");
  res.json(data);
});

app.get("/api/settings/rulesData", async (req, res) => {
  const data = await fetchData("/api/settings/rulesData", "rulesData");
  res.json(data);
});
